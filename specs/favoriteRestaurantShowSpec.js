...
import FavoriteMovieShowPresenter from '../src/scripts/views/pages/liked-restaurants/favorite-restaurant-show-presenter';
...
describe('Showing all favorite restaurants', () => {
  ...
  describe('When no restaurants have been liked', () => {
    ...
    it('should show the information that no restaurants have been liked', (done) => {
      document.getElementById('restaurants').addEventListener('movies:updated', () => {
